...
declare namespace languages.typescript {
    enum ModuleKind {
        None = 0,
        CommonJS = 1,
        AMD = 2,
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
declare namespace languages.css {    export interface DiagnosticsOptions {
...
declare namespace languages.json {    export interface DiagnosticsOptions {
        /**
